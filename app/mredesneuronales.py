...
#Realice pruebas con diferentes capas ocultas y diferentes neuronas, con 10 neuronas en 7 capas ocultas se obtiene un 97% de precision, no se obtiene mejora con mas capas ocultas
#Verificar si hay relacion con que son 7 variables continuas
#Tambien se realizaron pruebas con 5 y 15 neuronas por capa, pero falla el reporte de clasificacion, la precisiom disminuye a 49,50%
#Verificar como se si no esta sobreajustado?
clf = MLPClassifier(hidden_layer_sizes=(10, 10, 10, 10, 10, 10, 10), max_iter=1000, random_state=42)
...
# Entrenar el clasificador Red Neuronal
classifier = MLPClassifier(hidden_layer_sizes=(10, 10, 10, 10, 10, 10, 10), max_iter=1000, random_state=42)
...
plt.title('Curva ROC (Clasificador MLPClassifier)')
